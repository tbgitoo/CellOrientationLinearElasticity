...
chdir("/data/simulation_output/3D/cyclic_chip_compression_0_degrees")
cyclic_chip_compression_0=load_simulation("stretching_chip_mesh.vol")
...
print("Mean orientation angle , 3D, cells in gel in grooves, lower 100 micron layer, self-condensation and cyclic stretch in x-direction (along the grooves). ",
      "\n   Angle in degrees relative to stretch direction = ",
      Integrate(cell_orientation_angle_xy_self_condensation_and_cyclic_chip_compression_0*channel_gel_indicator,mesh)/
...
vtk = VTKOutput(ma=mesh, coefs=[cell_orientation_angle_xy_self_condensation_and_cyclic_chip_compression_0,most_compressive_angle_xy_self_condensation_and_cyclic_chip_compression_0, vector_smallest_compression_xy_chip_compression_0,stretch_ratio_0],
                names=["cell_orientation_angle","most_compressive_angle","cell_orientation_vector","stretch_ratio"], filename="3D_combined_condensation_stretch_0_degrees")
