...
# Cell orientation in degrees by atan from the xy vector for cyclic compression along the grooves
...
# Cell orientation in degrees by atan from the xy vector for cyclic compression perpendicular to grooves
...
vtk = VTKOutput(ma=mesh, coefs=[cyclic_chip_compression_0["u"],cell_orientation_angle_0,
                ...
                names=["u","cell_orientation_angle","preferred_cell_orientation_xy","preferred_cell_orientation", "strain_ratio_xy"
                       ], filename="3D_cyclic_chip_compression_0")
...
vtk = VTKOutput(ma=mesh, coefs=[cyclic_chip_compression_90["u"],cell_orientation_angle_90,
                ...
                names=["u","cell_orientation_angle","preferred_cell_orientation_xy","preferred_cell_orientation", "strain_ratio_xy"
                       ], filename="3D_cyclic_chip_compression_90")
