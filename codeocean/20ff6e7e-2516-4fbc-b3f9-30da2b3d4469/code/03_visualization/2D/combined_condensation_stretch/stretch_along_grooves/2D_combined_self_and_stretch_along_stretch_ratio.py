...
grid.plot(off_screen=True,scalars='stretch_ratio',
          ...
          screenshot="/results/supplementary_2/2D/combined_condensation_stretch/stretch_along_grooves/2D_combined_condensation_stretch_0_degrees_stretch_ratio.png")
