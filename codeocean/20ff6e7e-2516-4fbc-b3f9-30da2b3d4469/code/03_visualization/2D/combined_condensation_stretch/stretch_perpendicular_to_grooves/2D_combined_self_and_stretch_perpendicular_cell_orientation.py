...
grid.plot(off_screen=True,scalars='cell_orientation_angle',
          ...
          screenshot="/results/supplementary_2/2D/combined_condensation_stretch/stretch_perpendicular_to_grooves/2D_combined_condensation_stretch_90_degrees_cell_orientation.png")
